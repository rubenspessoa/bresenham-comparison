...
public class SimpleBasketBallCourt implements GLEventListener {
	...
	public SimpleBasketBallCourt(GUI gui) {
		this.gui = gui;
		pointOne = gui.getPointOne();
		pointTwo = gui.getPointTwo();
		glJPanel = gui.getSimpleGlPanel();
	...
	public void display(GLAutoDrawable glAutoDrawable) {
		...
		gl.glPushMatrix();
		Simple.drawLineWithSimple(gl, glJPanel, convertX(-0.6f), convertY(0f), convertX(0.6f), convertY(0f),
				courtlineSettings);
		gl.glPushMatrix();
		...
		Simple.drawLineWithSimple(gl, glJPanel, convertX(-0.8f), convertY(0f), convertX(0.8f), convertY(0f),
				courtlineSettings);
		gl.glPopMatrix();
	...
	public void drawInternalDownArea(GL2 gl) {
		...
		Simple.drawLineWithSimple(gl, glJPanel, convertX(0.1f), convertY(0f), convertX(0.2f), convertY(0.3f),
				courtlineSettings);
		gl.glPopMatrix();
